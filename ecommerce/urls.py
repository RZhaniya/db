...
urlpatterns = [
    ...
    path('admin-archived-products', views.archived_products_view, name='admin-archived-products'),


    path('admin-view-booking', views.admin_view_booking_view,name='admin-view-booking'),
    path('delete-order/<int:pk>', views.delete_order_view,name='delete-order'),
    path('update-order/<int:pk>', views.update_order_view,name='update-order'),
    path('admin-action-log', views.admin_action_log_view, name='admin-action-log'),
    ...
    path('customersignup/api/', views.customer_signup_api_view, name='customer_signup_api'),
